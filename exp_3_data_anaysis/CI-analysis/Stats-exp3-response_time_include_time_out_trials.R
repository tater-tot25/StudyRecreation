...
mydata <- read.table("exp_3_data_anaysis/CI-analysis/exp-data/response_time.csv", header=T, sep=",")
...
fname <- "exp_3_data_anaysis/results/exp3_response_time_bar.jpg"
...
print(gpie)
fname <- "exp_3_data_anaysis/results/exp3_response_time_pie.jpg"
...
fname <- "exp_3_data_anaysis/results/exp3_response_time_diff_bar.jpg"
...
fname <- "exp_3_data_anaysis/results/exp3_response_time_diff_pie.jpg"
ggsave(filename = fname, plot=g, width = 8, height= 1, device= pdf(), units = "in")
dev.off()
