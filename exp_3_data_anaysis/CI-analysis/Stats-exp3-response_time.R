...
mydata <- read.table("CI-analysis/exp-data/response_time.csv", header=T, sep=",")
...
fname <- "results/exp3_response_time_bar.pdf"
...
print(gpie)
fname <- "results/exp3_response_time_pie.pdf"
...
fname <- "results/exp3_response_time_diff_bar.pdf"
...
fname <- "results/exp3_response_time_diff_pie.pdf"
ggsave(filename = fname, plot=g, width = 8, height= 1, device= pdf(), units = "in")
dev.off()
