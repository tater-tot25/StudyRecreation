<div class="row mb-5" style="padding: 40px">
    <div class="col">
        ...
        <p>If you have questions about the study or encounter a problem with the research, contact any of the following researchers: Andrew Tate at <a href="mailto:andrew.tate@utah.edu">andrew.tate@utah.edu</a>, Gabriella Goodman at <a href="mailto:g.goodman@utah.edu">g.goodman@utah.edu</a>, Leena Butt at <a href="mailto:leena.butt@utah.edu">leena.butt@utah.edu</a>. In the event of an emergency, you may contact Prof. Sameer Patil at <a href="mailto:sameer.patil@utah.edu">sameer.patil@utah.edu</a>. Contact the Institutional Review Board (IRB) if you have questions regarding your rights as a research participant. Also, contact the IRB if you have questions, complaints or concerns which you do not feel you can discuss with the investigator. The University of Utah IRB may be reached by phone at (801) 581-3655 or by e-mail at <a href="mailto:irb@hsc.utah.edu">irb@hsc.utah.edu</a>. You may also contact the Research Participant Advocate (RPA) by phone at (801) 581-3803 or by email at <a href="mailto:participant.advocate@hsc.utah.edu">participant.advocate@hsc.utah.edu</a>.</p>
...
<script>
    ...
    $('body').on('next', function(e, type){
        // console.log("next");
        if (type === '<?php echo $id;?>'){
            measurements['consent'] = "yes";
            console.log("logging consent: "+ measurements['consent']);
        }
    });
</script>