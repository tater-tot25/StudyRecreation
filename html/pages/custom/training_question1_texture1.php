...
<script>
    ...
    $('body').on('show', function(e, type){
        ...
        if (type === '<?php echo $id;?>'){
            ...
            let img_path = "html/stimuli/generated_svg_training/<?php echo $condition;?>_<?php echo $textures_order_for_question1[$texture_index];?>"
        ...
        if (type === '<?php echo $id;?>'){
            ...
            for(let i = 0; i < trial_measure_training.length; i++){
                let obj = createLoggingObj(measurements['participant_id'], //participant_id
                    ...
                    '<?php echo $textures_order_for_question1[$texture_index]; ?>', //texture_condition, !!here can be question0 or question 1
